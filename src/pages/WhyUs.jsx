      ...
      <section className="py-40 px-6 bg-white">
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-16">
            <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.8 }} className="relative p-12 border border-border bg-muted/5 group hover:border-primary/30 transition-all duration-500 rounded-sm overflow-hidden">
              <div className="absolute top-0 left-0 w-1 h-0 bg-primary group-hover:h-full transition-all duration-500" />
              <div className="text-primary mb-6 opacity-70 group-hover:opacity-100 transition-opacity">
                <Globe size={32} strokeWidth={1.5} />
              </div>
              <h3 className="font-serif-heading text-2xl text-secondary mb-4 font-bold group-hover:text-primary transition-colors">Elite Network</h3>
            ...
            <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.8, delay: 0.1 }} className="relative p-12 border border-border bg-muted/5 group hover:border-primary/30 transition-all duration-500 rounded-sm overflow-hidden">
              <div className="absolute top-0 left-0 w-1 h-0 bg-primary group-hover:h-full transition-all duration-500" />
              <div className="text-primary mb-6 opacity-70 group-hover:opacity-100 transition-opacity">
                <Laptop size={32} strokeWidth={1.5} />
              </div>
              <h3 className="font-serif-heading text-2xl text-secondary mb-4 font-bold group-hover:text-primary transition-colors">Digital Readiness</h3>
              <p className="font-sans text-foreground/60 leading-relaxed font-light mb-8">
            ...
            <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.8, delay: 0.2 }} className="relative p-12 border border-border bg-muted/5 group hover:border-primary/30 transition-all duration-500 rounded-sm overflow-hidden">
              <div className="absolute top-0 left-0 w-1 h-0 bg-primary group-hover:h-full transition-all duration-500" />
              <div className="text-primary mb-6 opacity-70 group-hover:opacity-100 transition-opacity">
                <Compass size={32} strokeWidth={1.5} />
              </div>
              <h3 className="font-serif-heading text-2xl text-secondary mb-4 font-bold group-hover:text-primary transition-colors">Proactive Strategy</h3>
              <p className="font-sans text-foreground/60 leading-relaxed font-light mb-8">
      ...
      <section className="py-32 px-6 bg-muted/5 border-t border-border relative overflow-hidden">
        <div className="max-w-7xl mx-auto">
           <div className="text-center mb-24">
              <p className="font-serif-sub text-primary tracking-[0.4em] uppercase text-[10px] mb-6 font-bold">The Firm's Mandate</p>
           ...
           <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
              <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.8 }} className="p-10 border border-border bg-white shadow-sm hover:shadow-2xl hover:border-primary/40 transition-all duration-500 rounded-sm relative overflow-hidden group">
                 <div className="absolute top-0 left-0 w-1 h-0 bg-primary group-hover:h-full transition-all duration-500" />
                 <div className="text-primary mb-6 opacity-80 group-hover:opacity-100 transition-opacity">
                    <Target size={32} strokeWidth={1.5} />
                 </div>
                 <h3 className="font-serif-heading text-3xl text-secondary mb-4 font-bold transition-colors group-hover:text-primary">Our Mission</h3>
              ...
              <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.8, delay: 0.1 }} className="p-10 border border-border bg-white shadow-sm hover:shadow-2xl hover:border-primary/40 transition-all duration-500 rounded-sm relative overflow-hidden group">
                 <div className="absolute top-0 left-0 w-1 h-0 bg-primary group-hover:h-full transition-all duration-500" />
                 <div className="text-primary mb-6 opacity-80 group-hover:opacity-100 transition-opacity">
                    <Eye size={32} strokeWidth={1.5} />
                 </div>
                 <h3 className="font-serif-heading text-3xl text-secondary mb-4 font-bold transition-colors group-hover:text-primary">Our Vision</h3>
                 <p className="font-sans text-foreground/70 leading-relaxed font-light">
              ...
              <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.8, delay: 0.2 }} className="p-10 border border-border bg-white shadow-sm hover:shadow-2xl hover:border-primary/40 transition-all duration-500 rounded-sm relative overflow-hidden group">
                 <div className="absolute top-0 left-0 w-1 h-0 bg-primary group-hover:h-full transition-all duration-500" />
                 <div className="text-primary mb-6 opacity-80 group-hover:opacity-100 transition-opacity">
                    <ShieldCheck size={32} strokeWidth={1.5} />
                 </div>
                 <h3 className="font-serif-heading text-3xl text-secondary mb-4 font-bold transition-colors group-hover:text-primary">Core Values</h3>
                 <ul className="space-y-4 font-sans text-foreground/70 leading-relaxed font-light mt-6">
                    <li className="flex items-center gap-3"><div className="w-1.5 h-1.5 bg-primary/60 rounded-full" /> Integrity & Accountability</li>
                    <li className="flex items-center gap-3"><div className="w-1.5 h-1.5 bg-primary/60 rounded-full" /> Universal Accessibility</li>
                    <li className="flex items-center gap-3"><div className="w-1.5 h-1.5 bg-primary/60 rounded-full" /> Substantive Excellence</li>
                    <li className="flex items-center gap-3"><div className="w-1.5 h-1.5 bg-primary/60 rounded-full" /> Relentless Advocacy</li>
                 </ul>
              </motion.div>
           </div>
        </div>
              ...
              >
                <div className="relative w-full aspect-4/5 overflow-hidden rounded-sm mb-10 shadow-3xl">
                  ...
                  <div className="absolute inset-0 bg-secondary/90 transition-all duration-500 opacity-0 group-hover:opacity-100 p-12 flex flex-col justify-center items-center text-white backdrop-blur-sm">
                     ...
                     <p className="font-serif-sub uppercase tracking-[0.2em] text-[10px] text-primary mb-4 font-bold">Qualifications</p>
                     <p className="font-sans text-[11px] font-light mb-8 leading-relaxed">{member.qualifications}</p>
                     <p className="font-serif-sub uppercase tracking-[0.2em] text-[10px] text-primary mb-4 font-bold">Area of Expertise</p>
