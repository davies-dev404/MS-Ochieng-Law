...
export default function Privacy() {
  return (
    <Layout>
      <section className="pt-48 pb-24 px-6 bg-secondary text-white relative overflow-hidden border-b border-white/10">
        ...
        <div className="max-w-7xl mx-auto relative z-10 text-center">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }}>
            <p className="font-serif-sub tracking-[0.3em] uppercase text-[10px] mb-6 font-bold text-primary">Legal Sovereignty</p>
            <h1 className="font-serif-heading text-5xl md:text-7xl mb-8 font-bold uppercase tracking-tight">Privacy Policy.</h1>
            <p className="font-sans text-white/50 font-light max-w-2xl mx-auto">Last Updated: April 2024</p>
          </motion.div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="mt-32 pt-16 border-t border-border text-center">
            <p className="font-sans text-foreground/50 text-sm">
              ...
              <a href="mailto:privacy@msochieng.law" className="text-primary font-bold ml-2 hover:underline">privacy@msochieng.law</a>
            </p>
          </div>
        </div>
      </section>
