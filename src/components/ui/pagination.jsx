...
const PaginationLink = (
  { className, isActive, size = "icon", ...props } /*#__PURE__*/,
) =>
  _jsx("a", {
...
const PaginationPrevious = ({ className, ...props } /*#__PURE__*/) =>
...
const PaginationNext = ({ className, ...props } /*#__PURE__*/) =>
  _jsxs(PaginationLink, {
...
const PaginationEllipsis = ({ className, ...props } /*#__PURE__*/) =>
  _jsxs("span", {
    "aria-hidden": true,
