        ...
        <div className="max-w-7xl mx-auto relative z-10">
          ...
          >
            ...
            <div className="lg:w-1/3 grid grid-cols-1 gap-12 pt-20">
               {[
                 { label: "Institutional Focus", desc: "Dedicated to the needs of tier-1 corporations and government entities." },
                 { label: "Strategic Finesse", desc: "Navigating complex legal landscapes with surgical precision." },
                 { label: "Regional Supremacy", desc: "Unmatched depth across East African jurisdictions." }
               ].map((item, i) => (
                 <div key={i} className="border-l-2 border-primary/20 pl-8 hover:border-primary transition-colors">
                    <h4 className="font-serif-heading text-xl text-secondary mb-3 font-bold">{item.label}</h4>
