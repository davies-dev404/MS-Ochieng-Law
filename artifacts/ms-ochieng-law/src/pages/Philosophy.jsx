        ...
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-col lg:flex-row gap-24 items-center">
            <div className="lg:w-1/2">
              ...
              >
                <div>
                  <h3 className="font-serif-heading text-3xl md:text-4xl text-secondary mb-6 font-bold">Substantive Precision</h3>
                  <p className="font-sans text-foreground/60 text-lg font-light leading-relaxed mb-6">
                  ...
                  <p className="font-sans text-foreground/40 text-sm font-light leading-relaxed">
                ...
                <div>
                  <h3 className="font-serif-heading text-3xl md:text-4xl text-secondary mb-6 font-bold">Uncompromising Advocacy</h3>
                  <p className="font-sans text-foreground/60 text-lg font-light leading-relaxed mb-6">
