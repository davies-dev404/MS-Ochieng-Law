...
const practiceAreas = [
  {
    ...
    description: "Our corporate law practice is built on one belief: meticulous legal architecture prevents litigation before it begins. We counsel boards of directors, corporate secretariats, and C-suite executives on the full spectrum of corporate governance, from shareholder agreements and articles of association to cross-border holding structures and intra-group transactions.",
    services: [
              ...
              >
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-0 border border-primary/10">
                  {area.services.map((service, si) => (
                    <motion.div key={si} variants={fadeUp} className="group flex items-start gap-4 p-7 border border-primary/5 hover:bg-white/[0.025] transition-all duration-500">
