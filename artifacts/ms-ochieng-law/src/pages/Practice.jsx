...
const practices = [
  {
    ...
    subtitle: "Strategic Growth & Institutional Compliance",
    desc: "We provide preeminent advisory on high-value corporate mandates, navigating the intricate intersection of regulatory compliance and commercial ambition.",
    details: "Our practitioners are seasoned in the architecture of complex cross-border transactions, ensuring structural integrity from inception to post-closing integration.",
    subPractices: [
    ...
    matters: "Advising a Tier-1 regional bank on a $250M institutional capital injection and regulatory restructuring.",
  ...
  },
  {
    ...
    subtitle: "Industrial Harmony & Executive Stewardship",
    desc: "Our labor practice is dedicated to the sophisticated management of human capital through the lens of legal risk mitigation and industrial stability.",
    details: "From executive level compensation structuring to complex collective bargaining, we ensure that our institutional clients remain legally robust and culturally sound.",
    subPractices: [
    ...
    matters: "Successfully defending a multi-national tech firm in a high-profile class action redundancy litigation.",
  ...
  },
  {
    ...
    subtitle: "Precision Advocacy & Strategic Settlement",
    desc: "We approach litigation as a strategic extension of commercial interest, prioritizing the most efficient path to victory or settlement.",
    details: "Our advocacy is noted for its rigorous intellectual depth and relentless pursuit of foundational client interests across all superior courts of record.",
    subPractices: [
    ...
    matters: "Lead counsel in a $45M arbitration concerning infrastructure development and contractual frustration.",
  ...
  },
  {
    ...
    subtitle: "Asset Structuralization & Project Financing",
    desc: "Providing high-fidelity advisory on the acquisition, development, and disposal of significant real estate assets across the East African landscape.",
    details: "We navigate the complex terrain of land laws and structural finance, delivering seamless transition for high-frequency and high-value property portfolios.",
    subPractices: [
    ...
    matters: "Structuring the acquisition and development financing for a 500-unit mixed-use urban development project.",
  ...
  },
  {
    ...
    subtitle: "Capital Transactions & Regulatory Compliance",
    desc: "We advise leading financial institutions on complex structured finance arrangements, regulatory framework compliance, and high-value capital market transactions.",
    details: "Our banking team provides end-to-end counsel on syndicated lending, project finance, securities offerings, and the full spectrum of Central Bank regulatory obligations.",
    subPractices: [
    ...
    matters: "Adviser to a pan-African financial institution on a $180M syndicated facility for energy infrastructure.",
  ...
  },
  {
    id: 6,
    title: "Taxation Law",
    subtitle: "Strategic Tax Architecture & Dispute Resolution",
    desc: "Our tax practice provides integrated advisory on domestic and international taxation, combining deep legislative expertise with a commercial understanding of business objectives.",
    details: "From transfer pricing strategies to KRA dispute resolution, we structure tax positions that are both legally sound and commercially optimal for our clients.",
    subPractices: [
    ...
    matters: "Securing a favourable ruling in a landmark transfer pricing dispute involving a $30M assessment by KRA.",
  ...
  },
  {
    ...
    subtitle: "Brand Protection & Innovation Governance",
    desc: "We protect the intellectual capital of forward-thinking institutions — from brand trademarks and copyright portfolios to trade secrets and patent management across African markets.",
    details: "In an age of digital transformation, IP is increasingly a firm's most valuable asset. We provide the strategic framework to protect, commercialise, and enforce those rights internationally.",
    subPractices: [
    ...
    matters: "Enforcing trademark rights for a regional consumer brand against widespread counterfeiting across three East African jurisdictions.",
  ...
  },
  {
    ...
    subtitle: "Mobility Solutions for Institutional Talent",
    desc: "We facilitate seamless international mobility for corporate executives, skilled professionals, and institutional entities requiring regulatory certainty in cross-border operations.",
    details: "From work permit applications and citizenship advisory to investor visas and asylum representation, our immigration practice covers the full spectrum of residency and nationality law.",
    subPractices: [
    ...
    matters: "Managing the end-to-end immigration programme for a 40-person executive team during a regional headquarters relocation to Nairobi.",
