...
export default function Layout({ children }) {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground font-sans relative">
      ...
      <nav className={`fixed top-0 w-full z-50 transition-all duration-500 ${isScrolled || !isHome ? "bg-white/95 backdrop-blur-md py-3 border-b border-border shadow-sm" : "bg-white/90 backdrop-blur-xs py-4 border-b border-white/10 shadow-lg"}`}>
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 gap-x-16 gap-y-12">
              ...
              <div>
                ...
                <div className="flex flex-col gap-4">
                  ...
                  <a href="https://twitter.com" target="_blank" rel="noopener noreferrer" className="font-serif-sub tracking-widest text-[11px] uppercase text-white/60 hover:text-white transition-colors no-underline">Twitter / X</a>
