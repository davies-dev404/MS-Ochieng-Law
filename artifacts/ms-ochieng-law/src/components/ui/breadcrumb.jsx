...
const Breadcrumb = /*#__PURE__*/ React.forwardRef(({ ...props }, ref) =>
  /*#__PURE__*/ _jsx("nav", { ref: ref, "aria-label": "breadcrumb", ...props }),
);
...
const BreadcrumbSeparator = ({ children, className, ...props } /*#__PURE__*/) =>
  _jsx("li", {
    role: "presentation",
    "aria-hidden": "true",
...
const BreadcrumbEllipsis = ({ className, ...props } /*#__PURE__*/) =>
  _jsxs("span", {
    role: "presentation",
    "aria-hidden": "true",
