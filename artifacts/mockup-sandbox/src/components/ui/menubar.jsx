...
function MenubarMenu({ ...props }) {
  return /*#__PURE__*/ _jsx(MenubarPrimitive.Menu, { ...props });
}

function MenubarGroup({ ...props }) {
  return /*#__PURE__*/ _jsx(MenubarPrimitive.Group, { ...props });
}

function MenubarPortal({ ...props }) {
  return /*#__PURE__*/ _jsx(MenubarPrimitive.Portal, { ...props });
}

function MenubarRadioGroup({ ...props }) {
  return /*#__PURE__*/ _jsx(MenubarPrimitive.RadioGroup, { ...props });
}
      ...
      children: [
        ...
        _jsx("span", {
          ...
          children: _jsx(MenubarPrimitive.ItemIndicator, {
            /*#__PURE__*/ children: _jsx(Check, { className: "h-4 w-4" }),
          }),
        }),
        children,
      ],
    ...
    _jsxs(MenubarPrimitive.RadioItem, {
      ...
      children: [
        ...
        _jsx("span", {
          ...
          children: _jsx(MenubarPrimitive.ItemIndicator, {
            /*#__PURE__*/
            children: _jsx(Circle, { className: "h-4 w-4 fill-current" }),
          }),
        }),
        children,
      ],
