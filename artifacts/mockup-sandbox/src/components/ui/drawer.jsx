...
const Drawer = ({ shouldScaleBackground = true, ...props } /*#__PURE__*/) =>
...
const DrawerContent = /*#__PURE__*/ React.forwardRef(
  ({ className, children, ...props }, ref /*#__PURE__*/) =>
    _jsxs(DrawerPortal, {
      children: [
        /*#__PURE__*/ _jsx(DrawerOverlay, {}) /*#__PURE__*/,
...
const DrawerHeader = ({ className, ...props } /*#__PURE__*/) =>
  _jsx("div", {
...
const DrawerFooter = ({ className, ...props } /*#__PURE__*/) =>
  _jsx("div", {
